...
INSERT INTO category (category_id, parent_category_id, name)
VALUES (nextval('category_seq'), -1, 'Defense'),       -- id 5
       (nextval('category_seq'), 5, 'Before Defense'), -- id 6
       (nextval('category_seq'), 5, 'After Defense'); -- id 7
...
VALUES (nextval('_user_seq'), 'Admin', 'Admin', 'admin@email.com',
       ...
       (nextval('_user_seq'), 'Duygu', 'Çelik Ertuğrul', 'duygu.celik@emu.edu.tr',
       ...
       (nextval('_user_seq'), 'Secretary', 'Secretary', 'secretary@emu.edu.tr',
...
VALUES (nextval('category_permission_seq'), 'CHAIR', -1, 1), -- Medical Report
       ...
       (nextval('category_permission_seq'), 'CHAIR', -1, 5);
-- Defense
...
VALUES (nextval('category_permission_seq'), 'SECRETARY', -1, 1), -- Medical Report
       ...
       (nextval('category_permission_seq'), 'SECRETARY', -1, 5);
-- Defense
