...
public class DocumentService {
    ...
    public Document addDocument(MultipartFile file, String data, Long categoryId, User loggedInUser) throws IOException {
        Category category = categoryService.getCategoryWithDeletionFilter(categoryId, loggedInUser, false);
        Category parentCategory = null;
        if (category.getParentCategoryId() != -1) {
            parentCategory = categoryService.getCategoryWithDeletionFilter(category.getParentCategoryId(), loggedInUser, false);
        }
    ...
    public Document modifyDocumentCategory(DocumentModifyCategoryRequest request, User loggedInUser) {
        ...
        Category newCategory = categoryService.getCategoryWithDeletionFilter(request.categoryId(), loggedInUser, false);
